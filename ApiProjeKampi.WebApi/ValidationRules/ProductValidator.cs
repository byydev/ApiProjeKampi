...
namespace ApiProjeKampi.WebApi.ValidationRules
{
    public class ProductValidator:AbstractValidator<Product>
    {
        public ProductValidator()
        {
            ...
            RuleFor(x => x.Price).NotEmpty().WithMessage("Ürün Fiyatı Boş Geçilemez!").LessThan(0).WithMessage("Ürün fiyatı negatif olamaz!")
                .GreaterThan(0).WithMessage("Ürün Fiyatı bu kadar yüksek olamaz, girdiğiniz değeri kontrol ediniz!");
